...
// ===== STATIC DEFAULTS =====
const char* AP_SSID     = "temperature-humidity-001:192.168.4.1";
const char* AP_PASS     = "12345678";
const unsigned long SETUP_DURATION = 60000UL;  // 60 seconds

// ===== MODULE SETTINGS =====
String BASE_URL    = "";
const String UMID        = "temperature-humidity-001";
const String MODULE_TYPE = "temperature-humidity";
...
void sendSensorData(float t, float h) {
  ...
  Serial.print("Sent data result: "); Serial.println(result ? "OK" : "Fail");
